package demo.example.blogdemo.ascept;

import demo.example.blogdemo.config.WebConfig;
...
public class WebConfigAspect {
    ...
    public void logging(JoinPoint joinPoint){
        ...
        logger.info("Current Time"+ LocalDateTime.now()+" "+joinPoint.getSignature()
        .getName()+"called with"+objects);
    }
